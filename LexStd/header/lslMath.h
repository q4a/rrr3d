...
const D3DXVECTOR3      FPVector(5.4f, 0.0f, 1.0f);
const D3DXVECTOR3      LPVector(-3.2f, 5.0f, 1.0f);
const D3DXVECTOR3      RPVector(-3.2f, -5.0f, 1.0f);

const D3DXVECTOR3      FPVector2(-5.4f, 0.0f, 0.0f);
const D3DXVECTOR3      LPVector2(3.2f, -5.0f, 0.0f);
const D3DXVECTOR3      RPVector2(3.2f, 5.0f, 0.0f);

const D3DXVECTOR3      TSNVector(3.0f, 6.0f, 9.0f);
