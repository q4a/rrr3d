...
LRESULT CALLBACK MainWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MBUTTONDOWN:
	{
		...
		OnMouseClickEvent(lsl::mkMiddle, lsl::ksDown, lsl::Point(points.x, points.y), (wParam & MK_SHIFT) ? true : false, (wParam & MK_CONTROL) ? true : false);
		return 0;
	}
	...
	case WM_MBUTTONUP:
	{
		...
		OnMouseClickEvent(lsl::mkMiddle, lsl::ksUp, lsl::Point(points.x, points.y), (wParam & MK_SHIFT) ? true : false, (wParam & MK_CONTROL) ? true : false);
		return 0;
	}
