...
BaseSampler::BaseSampler(Type type): _type(type), _tex(0), _disabled(false), _offset(NullVector), _scale(IdentityVector), _rotate(NullQuaternion), _matChanged(true), _matFrame(0), _defMat(true), _filtering(sfAnisotropic), _filteringLevel(8)
{
}
