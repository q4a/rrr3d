...
extern unsigned int HINDEX = 0;
extern bool INIT_FIRST_TITLE = false;
...
void CMapEditorApp::InitR3D(CView* view)
{
	...
	desc.resolution = r3d::Point(1280, 720);	
	
	//очищаємо папку автобекапів.
	system("del /s /q /f C:\\Users\\%username%\\AppData\\Local\\XRayDevStudios\\MapEditor\\autosave");
	//створюємо важливі директорії.	
	system("mkdir C:\\Users\\%username%\\AppData\\Local\\XRayDevStudios\\MapEditor\\startup");
	system("mkdir C:\\Users\\%username%\\AppData\\Local\\XRayDevStudios\\MapEditor\\backups");
	system("mkdir C:\\Users\\%username%\\AppData\\Local\\XRayDevStudios\\MapEditor\\autosave");
