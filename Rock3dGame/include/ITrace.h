...
namespace r3d
{
	namespace edit
	{
		...
		using IWayPointRef = AutoRef<IWayPoint>;

		using IWayPathRef = AutoRef<class IWayPath>;
		...
		using IWayNodeRef = AutoRef<IWayNode>;
		...
		public:
			...
			using ControlEventRef = AutoRef<ControlEvent>;
		public:
			virtual IWayPointRef PickPoint(const Point& scrCoord) = 0;
