...
namespace r3d
{
	namespace edit
	{
		...
		public:
			...
			//
			virtual D3DXVECTOR3 GetLastPos() const = 0;
			virtual void SetLastPos(const D3DXVECTOR3& value) = 0;
			//
			virtual D3DXQUATERNION GetRot() const = 0;
			virtual void SetRot(const D3DXQUATERNION& value) = 0;
			//
			virtual D3DXQUATERNION GetLastRot() const = 0;
			virtual void SetLastRot(const D3DXQUATERNION& value) = 0;
			//
			virtual D3DXVECTOR3 GetScale() const = 0;
			virtual void SetScale(const D3DXVECTOR3& value) = 0;
			//
			virtual D3DXVECTOR3 GetLastScale() const = 0;
			virtual void SetLastScale(const D3DXVECTOR3& value) = 0;
			//
		...
		using IScNodeContRef = AutoRef<IScNodeCont>;

		class ISceneControl : public Object
		{
		public:
			enum SelMode { smNone, smLink, smMove, smCamLink, smDestroyer, smScale, smRotX, smRotY, smRotZ };

			enum DirMove { dmNone, dmX, dmY, dmZ, dmXY, dmXZ, dmYZ, dmView, cDirMoveEnd };

			using INode = IScNodeCont;
			using INodeRef = IScNodeContRef;
		public:
			virtual D3DXVECTOR3 ComputePoint(const D3DXVECTOR3& curPos, const D3DXVECTOR3& rayStart,
			                                 const D3DXVECTOR3& rayVec, DirMove dirMove,
			                                 const D3DXVECTOR3& centerOff) = 0;
			virtual D3DXVECTOR3 ComputePos(INode* node, const D3DXVECTOR3& rayStart, const D3DXVECTOR3& rayVec,
			                               DirMove dirMove, const D3DXVECTOR3& centerOff) = 0;
			...
			virtual bool GetCopyEvent() const = 0;
			virtual void SetCopyEvent(bool value) = 0;
		};
	}
}
