...
#include "d3d/d3dx9_compat.h"
#include "d3d/d3dx9math.h"

WINE_DEFAULT_DEBUG_CHANNEL(d3dx);

#ifndef D3DX9_NO_MATRIX_STACK
 ...
 */
/* Needs the texture and pixel-format machinery from Wine's d3dx_helpers.c,
 * which this project does not vendor. Unused here. */
#ifndef D3DX9_NO_SH_CUBEMAP
