/*
 * Half-float conversion helpers backing D3DXFloat32To16Array and
 * D3DXFloat16To32Array.
 *
 * Extracted verbatim from Wine's dlls/d3dx9_36/d3dx_helpers.c so this project
 * does not have to vendor that whole file, which drags in the image and
 * surface machinery we do not use.
 *
 * Copyright (C) 2008 David Adam
 * Copyright (C) 2008 Luis Busquets
 * Copyright (C) 2008 Jerome Gardou
