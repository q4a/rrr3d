...
private:
	...
	void DrawGraphic3d(Graphic3d* graphic, const D3DMATRIX& worldMat);
...
public:
	...
	void SetTransform(const D3DMATRIX& value);
...
private:
	...
	mutable D3DMATRIX _matrix[cMatrixChangeEnd];
