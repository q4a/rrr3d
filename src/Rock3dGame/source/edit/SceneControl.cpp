...
bool SceneControl::ComputeAxeLink(const AABB& aabb, const glm::mat4& aabbToWorld, const glm::mat4& worldToAABB, const D3DXVECTOR3& normOff, INode* ignore, float& outDistOff, const float distLink)
{
	bool res = false;
	outDistOff = distLink;
